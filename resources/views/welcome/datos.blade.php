...
<br><h4 class="text-white">PRUEBA MOLECULAR:</h4>
            <table class="table">
                <tr class="text-white">
                    ...
                    <td align="left"> <label class="form-check-label" for="dia_1" style="font-size:20px;">{{$cita->dia}}</label></td>
                </tr>
                <tr class="text-white">
                ...
                <tr class="text-white">
                    ...
                    <td align="left"> <label class="form-check-label" for="dia_1" style="font-size:20px;">{{$cita->hora}}</label></td>
                </tr>
            </table>
