    ...
    <div>
            ...
            <table class="table">
                <tr>
                    ...
                    <td align="left"> <label class="form-check-label text-white" for="dia_1" style="font-size:20px;">FECHA 1:  30 de marzo 2021</label></td>
                </tr>
                <tr>
                    ...
                    <td align="left"><label class="form-check-label text-white" for="dia_2" style="font-size:20px;">FECHA 2: 31 de marzo 2021</label></td>
                </tr>
            </table>
